...
#   2. BORINGCACHE_DEFAULT_WORKSPACE (CLI default)
#   3. WORKSPACE (Makefile variable)
#   4. built-in fallback
ENV_WORKSPACE="${WORKSPACE:-}"
ENV_DEFAULT_WORKSPACE="${DEFAULT_BORINGCACHE_WORKSPACE:-}"
DEFAULT_BORINGCACHE_DEFAULT="${BORINGCACHE_DEFAULT_WORKSPACE:-}"
...
elif [[ -n "$DEFAULT_BORINGCACHE_DEFAULT" ]]; then
    BORINGCACHE_WORKSPACE="$DEFAULT_BORINGCACHE_DEFAULT"
